...
function Hours(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: internalClassName }, { children: [locale.prefixHours !== '' && ((0, jsx_runtime_1.jsx)("span", { children: locale.prefixHours || locale_1.DEFAULT_LOCALE_EN.prefixHours })), (0, jsx_runtime_1.jsx)(CustomSelect_1["default"], __assign({ placeholder: locale.emptyHours || locale_1.DEFAULT_LOCALE_EN.emptyHours, value: value, unit: constants_1.UNITS[1], setValue: setValue, locale: locale, className: className, disabled: disabled, readOnly: readOnly, leadingZero: leadingZero, clockFormat: clockFormat, period: period }, selectProps))] })));
}
