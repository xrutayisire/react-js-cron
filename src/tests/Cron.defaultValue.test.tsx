...
describe('Cron defaultValue test suite', () => {
  ...
  const cases: {
    ...
    {
      title: 'every 6 months round-trips as */6',
      defaultValue: '0 5 1 */6 *',
      expectedValue: '0 5 1 */6 *',
      periodSelect: 'year',
      monthsSelect: 'every 6',
      monthDaysSelect: '1',
    ...
    {
      title: 'every 30 minutes round-trips as */30',
      defaultValue: '*/30 * * * *',
      expectedValue: '*/30 * * * *',
      periodSelect: 'hour',
      monthsSelect: undefined,
      ...
      weekDaysSelect: undefined,
      hoursSelect: undefined,
      minutesSelect: 'every 30',
    },
    {
      title: 'every 12 hours round-trips as */12',
      defaultValue: '0 */12 * * *',
      expectedValue: '0 */12 * * *',
      periodSelect: 'day',
      monthsSelect: undefined,
