...
describe('Cron defaultValue test suite', () => {
  ...
  test.each(cases)('should check $title', ({
    defaultValue,
    expectedValue,
    expectedPeriod,
    allowEmpty,
    ...
    if (periodSelect) {
      ...
      expect(screen.getByTestId('select-period').textContent).toContain(periodSelect);
    } else {
    ...
    if (monthsSelect) {
      ...
      expect(screen.getByTestId('custom-select-months').textContent).toContain(monthsSelect);
    } else {
    ...
    if (monthDaysSelect) {
      ...
      expect(screen.getByTestId('custom-select-month-days').textContent).toContain(monthDaysSelect);
    } else {
    ...
    if (weekDaysSelect) {
      ...
      expect(screen.getByTestId('custom-select-week-days').textContent).toContain(weekDaysSelect);
    } else {
    ...
    if (hoursSelect) {
      ...
      expect(screen.getByTestId('custom-select-hours').textContent).toContain(hoursSelect);
    } else {
    ...
    if (minutesSelect) {
      ...
      expect(screen.getByTestId('custom-select-minutes').textContent).toContain(minutesSelect);
    } else {
